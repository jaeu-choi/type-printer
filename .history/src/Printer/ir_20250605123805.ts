...
export interface TypeNodeFactory {
  createPrimitive(literal: string): TypeNode;
  createReference(name: string, typeArgs?: TypeNode[]): TypeNode;
  createUnion(members: TypeNode[]): TypeNode;
  createIntersection(members: TypeNode[]): TypeNode;
  createArray(elementType: TypeNode): TypeNode;
  createObject(members: ObjectMember[]): TypeNode;
  createConditional(info: ConditionalTypeInfo): TypeNode;
  createMapped(
