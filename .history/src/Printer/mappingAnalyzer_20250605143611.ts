...
//       const typeString =
//         structure.metadata?.finalTypeString || structure.value || "unknown";
...
//       const analyzedKeys = keyAnalyses.flatMap(
//         (analysis) => analysis.finalKeys
//       );
...
//         console.log(
//           `⚠️ Key count mismatch: analyzed=${analyzedKeys.length}, result=${resultProperties.length}`
//         );
//       } else {
