...
export function initializeTypeHandlers(options?: {
  ...
  // TODO: 나중에 추가될 핸들러들
  // registerHandler(new StringLiteralHandler());    // 더 세분화된 경우
  // registerHandler(new NumberLiteralHandler());    // 더 세분화된 경우
  // registerHandler(new BooleanLiteralHandler());   // 더 세분화된 경우
