...
export class ReferenceTypeHandler extends BaseTypeHandler {
  ...
  private handleUserDefinedReference(
    ...
    const metadata = this.createExtendedMetadata(type, node, context, {
      isBuiltin: false,
      analysisMethod: "reference-resolution",
      finalTypeString,
      debug: {
        warnings: [],
      },
  ...
  private createCircularReferenceNode(
    ...
    const metadata = this.createExtendedMetadata(
      undefined,
      undefined,
      context,
      {
        isBuiltin: false,
        analysisMethod: "circular-reference-detection",
        debug: {
  ...
  private createDepthLimitNode(
    ...
    const metadata = this.createExtendedMetadata(
      ...
      {
        isBuiltin: false,
        analysisMethod: "depth-limit-reached",
        debug: {
