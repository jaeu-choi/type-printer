...
export class TypeFormatter {
  ...
  private formatMappedTree(
    ...
    const keyValueRaw = iterations.children[0].value || "unknown";
    const resultValueRaw = iterations.children[1].value || "unknown";
    console.log("🔍 keyValueRaw:", keyValueRaw);
    console.log("🔍 resultValueRaw:", resultValueRaw);
    // 데이터 추출
