...
// type bar3 = bar & bar2;
// printer.printType("bar3", { expanded: true });
// printer.printType("foo2");
...
// type ResponseWithTime = SuccessResponse & WithTimestamp;

// printer.printType("ResponseWithTime");
// const res: ResponseWithTime = {
//   success: true,
//   data: "Loaded",
//   timestamp: new Date().toISOString(),
// };
printer.printType("bar2", { expanded: true });
// |---{
//   |---age: number;
//   |---email: {
//              |---name: number;
